                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right add-user">
                                <a href="{{ route('customer.create') }}" class="btn btn-sm btn-primary" id="add-user">{{
                                    __('Add Customer') }}</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <table id="tblUser" class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{{ asset('images/profile_photo/' . $user->profile_photo) }}" style="width:50px; height:50px; border-radius: 50%;" alt="" /></td>
                                        @else
                                        <td></td>
                                        @endif
